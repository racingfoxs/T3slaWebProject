	...
	<div className="container flex justify-between h-16 mx-auto">
      ...
      <span className=' px-2 text-2xl font-semibold'>TeslaCapsule</span>
		...
		<ul className="items-stretch hidden space-x-3 md:flex">
			...
			<li className="flex">
				<a rel="noopener noreferrer" href="#" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Capsule</a>
			</li>
			<li className="flex">
		...
		<button aria-label="nav" onClick={()=> alert("Didn't got time to make mobile nav")} className="flex justify-end p-4 md:hidden">
