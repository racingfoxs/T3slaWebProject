    ...
    <div className="container flex items-center lg:items-start flex-col flex-wrap justify-center p-6 mx-auto sm:py-2 lg:py-2 lg:flex-row lg:justify-center gap-10 ">
      ...
      >
        <ul className="inline-flex -space-x-px rounded-md shadow-sm dark:bg-gray-800 dark:text-gray-100">
          {currentPage > 1 && (
            <li className="inline-flex items-center px-2 py-2 text-sm font-semibold border rounded-l-md dark:border-gray-700">
              <Link
                aria-label="Previous"
                onClick={(e) => {
                  e.preventDefault();
          ...
          {currentPage < pageNumbers.length && (
            <li className="inline-flex items-center px-2 py-2 text-sm font-semibold border rounded-r-md dark:border-gray-700">
              <Link
                aria-label="Next"
                onClick={(e) => {
                  e.preventDefault();
